...
export default async function DashboardPage() {
  ...
  // Determine whose data to show: caregiver sees their patient, owner sees own
  ...
  // Refill alerts: meds where pill_count <= refill_threshold
  ...
  const ownerName = isCaregiver
    ? ((membership as any).owner?.full_name ?? 'Patient')
    : 'Your'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-5">
          <h2 className="text-xs font-black text-gray-400 uppercase tracking-widest mb-4">
            Active Medications ({meds?.length ?? 0})
          </h2>
