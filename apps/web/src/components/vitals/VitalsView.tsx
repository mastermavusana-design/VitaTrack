...
/**
 * Presentational vitals history. Fed by either the SSR read (flag off) or the
 * client-direct read wrapper (flag on) — a single source of markup.
 */
